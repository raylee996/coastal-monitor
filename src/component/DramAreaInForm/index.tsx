...
const DramAreaInFormPopup: React.FC<Props> = ({
  onChange,
  value,
  limit = 1,
  isNotRectangle,
  ...
  const [isShowActions, setIsShowActions] = useState(value ? true : false)
...
const DramAreaInForm: React.FC<Props> = (props) => {
  console.debug('DramAreaInForm')
  ...
  function showPopup() {
    popup(<DramAreaInFormPopup {...props} onConfirm={handleChange} />, { title: title || '地图选择', size: 'middle' })
  }
