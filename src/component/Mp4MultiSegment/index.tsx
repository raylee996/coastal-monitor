...
export interface Mp4MultiSegmentRefProps {
  /** 加减值 */
...
const Mp4MultiSegment = React.forwardRef<Mp4MultiSegmentRefProps, Props>(({ beginTime, endTime, segments, isPlay, speed, onDragChange }, ref) => {
  console.debug('Mp4MultiSegment')
...
export default Mp4MultiSegment