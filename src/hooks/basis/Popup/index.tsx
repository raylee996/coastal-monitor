...
import { windowstillOffset } from "../Windowstill";
...
const Popup: React.FC<Props> = ({
  ...
  const realStyle = useMemo<React.CSSProperties>(() => {
  ...
  if (popupRoot) {
    return ReactDOM.createPortal(
      <article className={`${styles.wrapper} hooks__Popup-wrapper`} style={realStyle} ref={wrapperRef}>

        <article className={`${contentClassName} hooks__Popup-content`} ref={contentRef} onClick={evt => evt.stopPropagation()}>

          {Header
            ? <Header title={realTitle} onClose={handleClose} />
            : <header className={`${styles.header} hooks__Popup-header`}>
              <div className={`${styles.title} hooks__Popup-title`}>{realTitle}</div>
          ...
          {Content
            ...
            : <section className={`${styles.body} hooks__Popup-body`}>{contentEle}</section>
          }
 ...
 */
const popup = function (ele: ReactElement, props?: PopupProps) {
  ...
  // console.log('popup windowstillOffset', windowstillOffset)
  ...
  function handleUnmount() {
    ...
    // console.log('popup windowstillOffset handleUnmount', windowstillOffset)
  }
}
