    ...
    <article className={styles.wrapper}>
      {
        isShow ?
          <div className={styles.comparsonBox}>
            <Badge.Ribbon text="原图" className={styles.image} style={{width:'44px'}}>
              <ImageSimple src={image1} defaultSrc={defaultImgPeople} width={60}/>
            </Badge.Ribbon>
            <div className={styles.progress}>
              <Progress type="circle" percent={similarity || 0} width={80} />
              <span>相似度</span>
            </div>
            <Badge.Ribbon text="对比图" className={styles.image} style={{width:'64px'}}>
              <ImageSimple src={image2} defaultSrc={defaultImgPeople} width={160}/>
            </Badge.Ribbon>
          </div> :
