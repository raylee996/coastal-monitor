...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var InitData = /** @class */ (function () {
        ...
        InitData.prototype.getMaxUndoNum = function () {
            return maxUndoNum;
        };
     ...
     */
    function saveCanvasToBase64(context, startX, startY, width, height, quality) {
    ...
    function toolClickEvent(toolName, index, mouseEvent, completeCallback, closeCallback) {
        ...
        if ((textInputController != null && data.getTextStatus()) ||
            ...
            if (text && text !== "") {
                var _c = data.getTextInfo(), positionX = _c.positionX, positionY = _c.positionY, color = _c.color, size = _c.size;
    ...
    var CreateDom = /** @class */ (function () {
        ...
        CreateDom.prototype.setToolBarIco = function () {
            ...
            var _loop_1 = function (i) {
                var item = this_1.toolbar[i];
                // 判断是否有需要隐藏的图标
                var icoHiddenStatus = false;
                for (var j = 0; j < this_1.hiddenIcoArr.length; j++) {
                    if (this_1.hiddenIcoArr[j] === item.title) {
                ...
                this_1.toolController.appendChild(itemPanel);
            };
            var this_1 = this;
    ...
    var DrawArrow = /** @class */ (function () {
         ...
         * @param color 箭头颜色
         */
        DrawArrow.prototype.draw = function (ctx, originX, originY, x, y, color) {
     ...
     */
    function calculateToolLocation(position, toolWidth, containerWidth, placement) {
        // 工具栏X轴坐标 = (裁剪框的宽度 - 工具栏的宽度) / 2 + 裁剪框距离左侧的距离
        var mouseX = (position.width - toolWidth) / 2 + position.startX;
        // 左对齐
        if (placement === "left") {
    ...
    function drawCrossImg(html) {
        ...
        imageNodes.forEach(function (element) {
            ...
            if (!href)
                return;
            if (href && href.startsWith("base64"))
                return;
    ...
    var ScreenShot = /** @class */ (function () {
        function ScreenShot(options) {
            ...
            this.mouseDownEvent = function (event) {
                ...
                if (_this.data.getToolName() == "text" &&
                    ...
                    _this.textInputController.style.fontSize = _this.fontSize + "px";
                ...
                if (_this.data.getToolClickStatus() && _this.data.getDragging()) {
                    ...
                    switch (_this.data.getToolName()) {
                        ...
                        case "round":
                            ...
                            break;
                        case "right-top":
                            _this.drawArrow.draw(_this.screenShotCanvas, startX, startY, currentX, currentY, _this.data.getSelectedColor());
                            break;
                        case "brush":
                            // 画笔绘制
        ...
        ScreenShot.prototype.loadScreenFlowData = function (triggerCallback) {
            ...
            setTimeout(function () {
                ...
                // 将获取到的屏幕截图绘制到图片容器里
                var imgContext = getCanvas2dCtx(_this.screenShotImageController, containerWidth, containerHeight);
                // 对webrtc源提供的图像宽高进行修复
        ...
        ScreenShot.prototype.registerContainerShortcuts = function (container) {
            ...
            container.addEventListener("keydown", function (event) {
                ...
                if (((event.metaKey || event.ctrlKey) && event.code === "Enter") ||
                    ...
                    drawText(text, _this.textInputPosition.mouseX, _this.textInputPosition.mouseY, _this.data.getSelectedColor(), _this.fontSize, _this.screenShotCanvas);
                    // 清空文本输入区域的内容
                    container.innerHTML = "";
                    // 隐藏输入框
                    _this.data.setTextStatus(false);
        ...
        ScreenShot.prototype.showToolBar = function () {
            if (this.toolController == null || this.screenShotContainer == null)
                return;
            // 计算截图工具栏位置
            var toolLocation = calculateToolLocation(this.drawGraphPosition, this.toolController.offsetWidth, this.screenShotContainer.width / this.dpr, this.placement);
